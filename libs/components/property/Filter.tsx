...
import { Button,Typography, Checkbox, FormControl, IconButton, InputLabel, MenuItem, OutlinedInput, Select, Stack, Tooltip } from "@mui/material";
    ...
    return (
        <Stack className={"filter-main "}>
            ...
            <Stack className={"find-your-home"} mb={"30px"}>
                <p className="title" style={{textShadow: "0px 3px 4px #b9b9b9"}}>Location</p>
                <Stack
